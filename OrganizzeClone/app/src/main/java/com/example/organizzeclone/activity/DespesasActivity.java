...
public class DespesasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        input_valor= findViewById(R.id.input_valor_despesa);
        input_data = findViewById(R.id.input_data_despesa);
        input_categoria= findViewById(R.id.input_categoria_despesa);
        input_descricao= findViewById(R.id.input_descricao_despesa);
        fab_salvar= findViewById(R.id.fab_salvar_despesa);
            ...
            public void onClick(View view) {
                if(validarCampos()){
                    ...
                    if(movimentacaoDAO.salvar_movimentacao(movimentacao)){
                        Toast.makeText(DespesasActivity.this, "Despesa" +
